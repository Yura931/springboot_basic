package com.fastcampus.springboot.ch3.aop;
...
public class AppMain {
    public static void main(String[] args) throws Exception {
        Class myClass = Class.forName("com.fastcampus.springboot.ch3.aop.MyClass");
...
class MyAdvice {
    ...
    void invoke(Method m, Object obj, Object... args) throws Exception {
        if(m.getAnnotation(Transactional.class) != null)  // pattern true인 경우만 출력
